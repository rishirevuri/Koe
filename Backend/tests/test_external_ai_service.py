        ...
        "items": [
            {
                ...
                "manager_note": "Normalized one half-empty bottle as 0.5 bottle.",
            },
            {
                "item_name": "Eggs",
                "quantity": 120,
                ...
                "manager_note": "Converted 10 dozen eggs into 120 eggs.",
            },
        ],
    ...
    assert parsed["items"] == [
        {
            ...
            "manager_note": "Quantity was vague; manager should confirm exact count.",
        }
    ]
